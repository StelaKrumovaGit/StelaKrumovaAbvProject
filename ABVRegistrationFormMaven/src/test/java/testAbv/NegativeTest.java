...
public class NegativeTest {
	...
	public void emptyFieldValidation() {
	     ...
	     */
	    WebElement emptUserErrM=driver.findElement(By.xpath("(//div[contains(@class,'abv-row x')]//div)[3]")); //problem with element!!!!
		 ...
		 */
			WebElement emptyConfPass=driver.findElement(By.cssSelector("form#regform>div:nth-of-type(4)>div:nth-of-type(2)"));
	...
	public void checkTelField(String telefon) {
		...
		telNum.sendKeys(telefon);
		   ...
		   telNum.clear();
			...
			clickCreateProf();
			System.out.println("Telefon is:" + telNum.getText());
         	errMTelefon_empty=driver.findElement(By.xpath("//div[@class='abv-phone']/following-sibling::div[1]"));
	...
	public void invalidRegistrationIndex(String userName,String pass,String confirmPass,String telefon,String fName,
        ...
        if (userN==1||userN==2) {
		WebElement messageUser= driver.findElement(By.cssSelector(".abv-domain.abv-row.x > .abv-error.abv-messageGray"));
		...
		/*
		 * cannot use Bulgarian language!!! Handle with:
		 ...
		 */
		 ...
		 WebElement message2= driver.findElement(By.xpath("//div[text()='Полето Парола не може да съдържа по-малко от 8 символа.']"));
		...
		WebElement errMTelefon=driver.findElement(By.cssSelector("form#regform>div:nth-of-type(6)>div:nth-of-type(2)"));
